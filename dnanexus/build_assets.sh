...
ASSETS=('awscli_asset' 'bedtools_asset' 'bioconductor_asset' 'common_asset' 'idr2_asset' 'macs2_asset' 'picard_asset' 'samtools_asset' 'spp_asset' 'trimmomatic_asset' 'ucsc_asset')
